...
/**
 * Slider Addon widget class.
 *
 * @since 1.0.0
 */
class Slider_Addon extends Widget_Base
{
    /**
     * Class constructor.
     *
    ...
    public function __construct($data = array(), $args = null)
    {
        ...
        wp_register_style('slider-addon', plugins_url('/assets/css/sliderAddon.css', ELEMENTOR_SLIDER_ADDON), array(), '1.0.0');
    }
    ...
    {
        return __('Slider Addon', 'elementor-slider-addon');
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            'section_content',
            array(
                'label' => __('Content', 'elementor-slider-addon'),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => __('Title', 'elementor-slider-addon'),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => __('Description', 'elementor-slider-addon'),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => __('Content', 'elementor-slider-addon'),
            )
        );
