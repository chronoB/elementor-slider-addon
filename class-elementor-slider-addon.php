...
/**
 * Main Elementor Slider Addon Class
 *
 * The init class that runs the Elementor Slider Addon plugin.
 ...
 */
final class Elementor_Slider_Addon
{
    /**
     * Plugin Version
     *
     ...
     */
    public const MINIMUM_ELEMENTOR_VERSION = '3.0.0';
    ...
    {
        load_plugin_textdomain('elementor-slider-addon');
    }
    ...
    {
        deactivate_plugins(plugin_basename(ELEMENTOR_SLIDER_ADDON));
...
// Instantiate Elementor_Slider_Addon.
new Elementor_Slider_Addon();
